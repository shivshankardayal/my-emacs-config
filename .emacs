...
(fset 'uli
       [?< ?> left ?d ?: ?u ?l ?i ?n ?k ?  ?u ?r ?l ?= ?\" ?\" right ?< ?> left ?d ?: ?c ?i ?t ?e ?t ?i ?t ?l ?e right ?< ?> left ?/ ?d ?: ?c ?i ?t ?e ?t ?i ?t ?l right ?< ?> left ?/ ?d ?: ?u ?l ?i ?n ?k C-left C-left C-left C-left C-left C-left left left left])
(fset 'ifeq
...
(tool-bar-mode -1)
;; delete trailig white space before saving
